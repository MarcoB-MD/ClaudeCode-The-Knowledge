...
- Images / notes — for any entry type: ask if there are any screenshots, diagrams, or handwritten notes to attach; if yes, ask for the filename inside the `notes_handwritten/` folder
